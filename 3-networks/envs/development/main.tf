...
locals {
  ...
  base_private_service_cidr = "10.0.72.0/19"
  base_subnet_primary_ranges = {
    (var.default_region1) = "10.0.8.0/21"
  ...
  restricted_private_service_cidr = "10.0.200.0/21"
  restricted_subnet_primary_ranges = {
    (var.default_region1) = "10.0.136.0/21"
