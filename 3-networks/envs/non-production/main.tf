...
locals {
  ...
  base_private_service_cidr = "10.0.80.0/21"
  base_subnet_primary_ranges = {
    (var.default_region1) = "10.0.16.0/21"
    (var.default_region2) = "10.0.48.0/21"
  }
